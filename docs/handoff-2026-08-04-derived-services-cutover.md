...
> ## ⚠ 接手请先看 `docs/handoff-2026-08-04-client-auth-dependency-recovery.md`
>
> 本文件已经层层追加到 §16，**读起来要考古**。它记的是**切流当天上午**：为什么切、
> 怎么切、怎么回滚、以及那 18 分钟停摆。这些仍然有效，但**不是当前状态**。
>
> **当前状态、剩余工作、以及会咬人的坑，全在上面那份新交接里。**
> 需要追溯切流本身时再回来读这份；§16.1–16.5 是当天下午逐批的原始记录。
