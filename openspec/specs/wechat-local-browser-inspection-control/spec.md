# wechat-local-browser-inspection-control Specification

## Purpose
TBD - created by archiving change wechat-local-browser-inspection-control. Update Purpose after archive.
## Requirements
