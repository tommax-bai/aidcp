# native-facebook-localized-action-semantics Specification

## Purpose
TBD - created by archiving change restore-native-facebook-localized-action-parity. Update Purpose after archive.
## Requirements
