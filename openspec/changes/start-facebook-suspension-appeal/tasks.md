...
- [ ] 3.3 Commit the Edge and control changes, rebase/fast-forward them onto current defaults, push both defaults, and record source SHAs plus the explicit no-package/no-install/no-live-click boundary.
