...
- [ ] 4.3 Update this checklist with repo commit SHAs and validation evidence, run `openspec validate facebook-batch-environment-creation --strict`, then integrate and push the clean default branches without packaging an Edge installer.
