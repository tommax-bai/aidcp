...
- [ ] 4.1 Implement Facebook in-container keyword search capability: open a configured container (Page/Group), run its in-container search for a given keyword, and extract bounded candidate posts from the results. MUST NOT perform whole-site Facebook search.
