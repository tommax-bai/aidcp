...
- Keep at most `AIDCP_CURATED_REFERENCE_IMAGE_LIMIT` images per row, hard cap 18 (= Xiaohongshu per-note image max; 9 -> 30 -> 18 across changes raise-curated-scrape-image-cap and refine-curated-scrape-image-cap-18; decoupled from the publish-side ≤9 platform limit).
