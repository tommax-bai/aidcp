...
- [x] 3.3 Run focused Edge tests, full Edge tests and typecheck; visually verify populated and empty states at desktop and narrow supported widths.
  <!-- Edge 1749476: focused renderer suites passed; full `npm test` passed 2269/2269; `npm run typecheck` passed; browser QA covered populated/empty desktop states and a 620px responsive frame. -->
...
- [ ] 4.2 Commit control and Edge changes, rebase onto the latest defaults, rerun required checks and fast-forward push the default branches.
