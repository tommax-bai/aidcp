...
- [x] 7.3 edge 改动**须重新打包桌面客户端**才在运营机生效。 <!-- 归档口径：打包按 CLAUDE.md §6 属用户显式触发动作，明确不在本 change 范围内；未出包不构成归档门槛 -->

## 8. 真机验收（登记 backlog，不在本 change 内判定）

- [x] 8.1 慢群页加群后首帖评论跑通。 <!-- 已解耦登记 backlog 簇 119.1/119.2；按本仓清账口径，真机验收不 gate 归档 -->
- [x] 8.2 空首页账号可再次切 Reels、不再零命令悬停。 <!-- 已解耦登记 backlog 簇 119.4/119.5 -->
- [x] 8.3 首帖目标身份原值取证，判定 design §6 那条线索。 <!-- 已解耦登记 backlog 簇 119.8；成立则须另起 change -->
...
- [x] 12.2 edge 改动须重新打包桌面客户端才在运营机生效。 <!-- 同 7.3：打包属用户显式触发，不在本 change 范围；真机复核见 backlog 簇 120 -->
