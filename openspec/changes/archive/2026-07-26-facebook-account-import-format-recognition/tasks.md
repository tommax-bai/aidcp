...
- [x] 4.2 Record repo/commit/validation/deviation evidence in this task file, commit the OpenSpec change, fast-forward integrate it into control `main`, and push `origin/main`; do not package an installer. <!-- control artifact commit 8813101 and implementation record 64e43a5; strict validation PASS after rebase to latest origin/main; canonical main fast-forwarded and origin/main pushed through 64e43a5; runtime deployment is not applicable to this local Edge source change, and no installer was packaged -->
