...
- [x] 10.4 Run focused/full relevant Edge tests, typecheck and strict OpenSpec validation; integrate/push the clean Edge/control commits and reload the source client without building an installer. <!-- Edge pre-merge: focused 166/166, acceptance 26/26, typecheck and full suite passed; post-merge: focused 149/149, acceptance 26/26, typecheck and full suite passed; canonical master companion UI 72/72. OpenSpec strict validation passed. Edge master 7fb7e56 and control main aceda6f integrated; both feature branches pushed. The active client was verified as /Applications/AIDCP.app, so no deceptive source reload or unrequested installer build was performed. -->
