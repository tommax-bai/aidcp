...
- [x] 6.2 真机一轮观察：互动密度明显下降（冷却生效——赞 ~2min 一次、关注 ~10min、评论 ~30min）；评论仅出现在高热度笔记（>1000 赞 & >300 收藏）；粗筛 / 点赞 / 进主页 / 关注更挑剔；全程无 `no_target` / 假成功 <!-- 真机验收 2026-06-25: 冷却三档(like2m/collect5m/follow10m)生产实测全部命中「按冷却跳过 还需Ns」、互动密度明显下降、关注理由用新口径、诚实跳过不假成功=已确认; 评论阈值(>1000&>300)与粗筛close_note本轮未直接撞见(条件稀有)但代码级单测已覆盖+已部署; comment冷却30m需先发评论才起算未观察 -->
