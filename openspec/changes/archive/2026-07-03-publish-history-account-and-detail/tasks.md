...
- [x] 8.3 进度回写本仓 tasks.md（HTML 注释标 `<repo> <commit-sha>`，部署后追加 `<date> deployed`） <!-- 1-7 已回写本文件（cloud 497d1bc / edge 842ff30 / console 771378e）；§8.1 已追加 deployed 注记（cloud 497d1bc，2026-06-24 deployed）；回写部分已完成，仅余 8.2 真机另行追踪 -->
