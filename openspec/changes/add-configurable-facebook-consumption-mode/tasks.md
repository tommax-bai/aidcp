...
- [ ] 7.8 Integrate and push clean default branches, then deploy DEV only if the shared-database schema gate proves OL compatibility; do not package Edge, deploy OL or perform unapproved Facebook platform actions.
