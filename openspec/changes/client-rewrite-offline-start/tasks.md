...
- [ ] 4.2 Commit and push the OpenSpec change with repo SHA and validation evidence recorded in this file.
- [ ] 4.3 Deploy the clean integrated cloud `master` to `dev` following the named-target checklist; verify service, listener, health, Feishu, and PostgreSQL, or roll back on failure.
