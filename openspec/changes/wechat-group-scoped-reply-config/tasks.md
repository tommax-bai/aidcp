...
- [ ] 6.6 Back up the shared database, execute the approved test-strategy cleanup, deploy only the committed Cloud/Console artifacts to dev, and verify row counts, scoped fail-closed behavior, health and unrelated services without touching ol.
