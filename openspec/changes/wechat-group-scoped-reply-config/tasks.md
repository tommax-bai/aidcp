...
- [ ] 6.5 Run focused/full proportional Cloud and Console tests, typechecks/build, v2 fixture checks and strict OpenSpec validation; commit, integrate and push defaults.
