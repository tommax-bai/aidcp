...
- [ ] 5.4 Run proportionate Edge/Cloud validation and strict OpenSpec validation, then record commit, integration, push, and Cloud `dev` deployment evidence without building an Edge installer.
