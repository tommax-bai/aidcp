...
- If billing details do not contain a matching token quantity and billed amount sample, cloud SHALL return `no_billing_sample` for that target and MUST NOT write a price snapshot.
