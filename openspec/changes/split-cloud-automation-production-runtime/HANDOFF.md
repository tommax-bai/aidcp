...
> **重整于 2026-08-01 晚，现状段刷新于 2026-08-03（门清零那一批）。**
>
> **一句话现状：门已清零（0 条），第 4 段完成，剩第 5 段收尾。** 细节见下面那段「现状」。
>
> **怎么读这份文档**：
...
> | 项 | 状态 |
> | --- | --- |
> | 5.1 / 5.2 六仓同步 + 逐仓 typecheck + 全量测试 | 每批都在做，当前全绿、零漂移 |
> | 5.3 分层验收如实分开记 | 口径已定，随归档写死 |
> | 5.4 dev 部署 | 已跟到 cloud `0d507c5`；**只动派生仓的批次与 dev 无关** |
> | 5.5 真机项登记 backlog | 簇 60 已登记（三进程真跑 + 飞书 `/delegate` 从未真跑过） |
>
