...
- [ ] 6.3 Add focused regressions for failed/unwired notifications, run Cloud and Console validation, strictly validate OpenSpec, integrate, and deploy the clean default revisions to dev.
