...
- [ ] 5.2 Run `openspec validate facebook-reels-random-follow --strict`; record Cloud/Edge/control commits, validation totals, deviations, and the no-installer boundary in this file.
