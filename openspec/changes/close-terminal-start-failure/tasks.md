...
- [ ] 4.3 Record repo/commit/validation/deviation evidence in this task file, run strict OpenSpec validation, commit with explicit pathspecs, fetch/rebase onto latest `origin/main`, fast-forward integrate to the canonical control checkout while preserving unrelated untracked files, and push `main`.
