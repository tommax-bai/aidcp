...
- Existing `page.cards` fields (`listKind`, `isVideo`, `noteId`, author/title) and existing interaction commands/receipts are reused; no protocol shape, database schema, Console setting, or Edge installer is required.
