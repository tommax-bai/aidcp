...
- [ ] 3.3 Run `openspec validate count-ambiguous-facebook-comment-submissions --strict` and record repository SHAs, validation, and deviations.
- [ ] 3.4 Rebase the Cloud feature branch on the latest default, rerun the landing gate, fast-forward integrate, commit/push the control artifacts, and push both default branches without force.
