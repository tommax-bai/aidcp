...
- [ ] 7.4 Rebase onto the latest defaults, fast-forward merge and push aidcp-edge plus control OpenSpec refs, record final evidence, and do not build an installer or touch Cloud/ol.
