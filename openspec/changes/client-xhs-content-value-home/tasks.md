...
- [x] 4.5 Deploy the integrated Cloud revision to `dev` from the canonical checkout with backup, health/readiness/log verification, and rollback evidence; record that Edge source delivery does not produce an installer.
  <!-- Dev deployed from clean Cloud master 313eba2992d0031ff833da9b0ae6fda6c8a6c82a. Rollback: /opt/aidcp/cloud.bak.20260722-142222Z.tar.gz + /opt/aidcp/cloud/.env.bak.20260722-142222Z. Verified active/NRestarts=0; 8787/8090/8091/5432; public and local panel/client health; PG table 18 columns/4 indexes; executionTarget=dev/recovered=0; Feishu WSClient onReady; five key artifact hashes; no startup errors; isales-api/isales-scheduler active. Edge is source-only at a742611e4972443f3a519f1a4f6703ef669909a6; no installer was built or distributed. -->
