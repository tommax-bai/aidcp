...
- [ ] 3.3 Run `openspec validate repair-native-facebook-group-join-decoding --strict` and record repositories, commits, test counts, real-browser evidence, deviations, and delivery boundaries.
- [ ] 3.4 Commit and push the isolated Edge and control branches, rebase and fast-forward integrate them into the current default branches, rerun required post-rebase gates, and leave packaging/install/release untouched.
